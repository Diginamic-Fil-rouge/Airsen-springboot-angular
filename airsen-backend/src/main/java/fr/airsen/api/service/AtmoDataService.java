...
public class AtmoDataService {
    ...
    private Mono<AirQuality> convertAndSaveAirQuality(AtmoAirQualityResponse atmoResponse) {
        return Mono.fromCallable(() -> {
            ...
            Commune commune = communeRepository.findByInseeCode(atmoResponse.communeInsee())
                .orElse(null);
            ...
            // Map pollutant codes (ATMO codes: 1=Good, 2=Moderate, 3=Unhealthy for sensitive, 4=Unhealthy, 5=Very unhealthy, 6=Hazardous)
            // Convert codes to approximate concentrations (μg/m³) for storage
