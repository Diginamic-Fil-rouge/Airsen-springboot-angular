...
public interface CommuneDetailMapper {
    ...
    @Mapping(source = "apparentTemperature", target = "apparentTemperature")
    @Mapping(source = "precipitation", target = "precipitation")
    @Mapping(source = "rain", target = "rain")
    @Mapping(source = "showers", target = "showers")
    @Mapping(source = "snowfall", target = "snowfall")
    @Mapping(source = "cloudCover", target = "cloudCover")
    @Mapping(source = "windGusts", target = "windGusts")
    @Mapping(source = "pressureMsl", target = "pressureMsl")
